...
The debounced function comes with a cancel method to cancel delayed func invocations and a flush method to immediately invoke them. Provide options to indicate whether
func should be invoked on the leading and/or trailing edge of the wait timeout. The func is invoked with the last arguments provided to the debounced function.
...
function debounce(callback) {
  ...
  function innerFunc(delayOfCalls) {
    ...
    var callThisToCancel = setTimeout(() => {
      // console.log(delayOfCalls);
      // console.log(callback);
      callback();
    }, 3000);
    //we can cancel the setTimeout if the time between the evocation of the func is not between the dalay/wait time passed in.
